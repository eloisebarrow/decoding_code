...
class DecksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create deck" do
    assert_difference('Deck.count') do
      post decks_url, params: { deck: { is_public: @deck.is_public, topic: @deck.topic, user_id: @deck.user_id } }, as: :json
    end
  ...
  test "should update deck" do
    patch deck_url(@deck), params: { deck: { is_public: @deck.is_public, topic: @deck.topic, user_id: @deck.user_id } }, as: :json
    assert_response 200
  end
